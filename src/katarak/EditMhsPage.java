 ...
 * @author root
 */
public class EditMhsPage extends javax.swing.JFrame {
    Connection con;
    ResultSet rs;
    Statement stat;
    String sql;
    ...
    public EditMhsPage() {
        ...
        LoadDetailMhs();
        loadmk();
        mhsfin = LblNamaMhs.getText();
    }

    private void LoadDetailMhs() {
        try {
            Koneksi nip = new Koneksi();
            String hashfin = nip.getSession();
            String mkfin = nip.getSelectedMK();
            String mhsfin = nip.getSelectedMhs();
            String showdetailmk = "SELECT * FROM detailmahasiswa WHERE namamhs='"+mhsfin+"' AND matakuliah='"+mkfin+"' AND otoritas='"+hashfin+"'";
    ...
    private void loadmk() {
        ...
        try {
            ...
            String hashfin = nip.getSession();
            String mkfin = nip.getSelectedMK();
            String showmk = "SELECT namamk FROM detailmatakuliah WHERE namamk='"+mkfin+"' AND otoritas='"+hashfin+"'";
    ...
    private void initComponents() {
        ...
        BtnHapus.setFont(new java.awt.Font("Quicksand", 1, 12)); // NOI18N
        ...
        jPanel2.add(BtnHapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 20, -1, -1));
        ...
        jLabel14.setText("Alamat e-mail");
        ...
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 290, -1, -1));
    ...
    private void UpdateData() {
        ...
        try {
            sql = "SELECT * FROM detailmahasiswa WHERE namamhs='"+LblNamaMhs.getText()+"' AND matakuliah='"+mkfin+"' AND otoritas='"+hashfin+"'";
            ps = con.prepareStatement(sql);
            rs = ps.executeQuery();
            if(rs.next()) {
                String statone = "UPDATE detailmahasiswa SET namamhs='"+nim+" - "+nama+"', nim='"+nim+"', nohp='"+nohp+"', nama='"+nama+"', ipk='"+ipk+"', ttl='"+ttl+"', email='"+email+"' WHERE namamhs='"+LblNamaMhs.getText()+"' AND matakuliah='"+mkfin+"' AND otoritas='"+hashfin+"'";
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        ...
        int dialogResult = JOptionPane.showConfirmDialog(null, "Apakah anda yakin ingin menghapus mahasiswa " + mhsfin + " ?", "Warning", dialogButton);
        if(dialogResult == JOptionPane.YES_OPTION) {
            try {
                Koneksi ref = new Koneksi();
                String statone = "DELETE FROM detailmahasiswa WHERE namamhs='"+mhsfin+"'";
                ps = con.prepareStatement(statone);
                ps.execute();
                ref.setRefreshCmb("yes");
    ...
    private void InputNamaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_InputNamaFocusLost
        String namamhs = InputNama.getText();
        LblNamaMhs.setText(namamhs);
